...
def feature_sampling(mlvl_feats, reference_voxel, pc_range, img_metas, img_depth=None, num_sweeps=1, num_cam=6, fp16_enabled=False):
    # import pickle
    # pickle.dump([mlvl_feats, reference_voxel, pc_range, img_metas, img_depth, num_sweeps, num_cam, fp16_enabled], open('a.pkl','wb'))
    # exit()
    ...
    for img_meta in img_metas:
        ...
        # print([i.shape for i in img_meta['lidar2img']])
        # lidar2img.append([np.eye(4).reshape(1,4,4) for i in range(6)])
