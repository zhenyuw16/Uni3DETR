...
class LoadMultiViewMultiSweepImageFromFilesIndoor(object):
    ...
    def __call__(self, results):
        ...
        if 'depth2img' in results:
            lidar2img = np.eye(4)
            if results['depth2img'].shape[0] == 3:
                lidar2img[:3, :3] = results['depth2img']
            else:
                lidar2img[:4, :4] = results['depth2img']
        else:
            lidar2img = np.eye(4)
            if results['lidar2img'].shape[0] == 3:
                lidar2img[:3, :3] = results['lidar2img']
            else:
                lidar2img[:4, :4] = results['lidar2img']
